...
type Choice = 'single-player' | 'multi-players' | 'stage-list' | 'gallery' | 'replay'

const CHOICES: Choice[] = ['single-player', 'multi-players', 'stage-list', 'gallery', 'replay']
    ...
    return (
      <g className="game-title-scene">
        ...
        <TextButton
          ...
          y={12 * B}
          textFill="white"
          onMouseOver={() => this.setState({ choice: 'replay' })}
          onClick={() => this.onChoose('replay')}
        />
        <Tank
          tank={
            new TankRecord({
