...
export const N_MAP = {
  ...
  SWAMP: FIELD_SIZE / ITEM_SIZE_MAP.SWAMP,
  MOUNTAIN: FIELD_SIZE / ITEM_SIZE_MAP.MOUNTAIN,
  TELEPORTER: FIELD_SIZE / ITEM_SIZE_MAP.TELEPORTER,
  GLASS: FIELD_SIZE / ITEM_SIZE_MAP.GLASS,
  MINE: FIELD_SIZE / ITEM_SIZE_MAP.MINE,
}
